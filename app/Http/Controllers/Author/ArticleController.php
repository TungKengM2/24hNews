<?php
    ...
    class ArticleController extends Controller
    {
        ...
        protected $writingGuidelineService;

        public function __construct(ModerationService $moderationService, WritingGuidelineService $writingGuidelineService)
        {
            $this->moderationService = $moderationService;
            $this->writingGuidelineService = $writingGuidelineService;
        }
        ...
        public function update(Request $request, Article $article)
        {
            try {
                ...
                // Kiểm tra các tiêu chí viết bài
                $validationResults = $this->writingGuidelineService->validateArticle($request->all());
                ...
                if (!empty($validationResults['errors'])) {
                    return redirect()
                        ...
                        ->with('warnings', $validationResults['warnings']);
                }
