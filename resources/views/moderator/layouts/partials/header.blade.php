<header class="main-header">
	<div class="d-flex align-items-center logo-box justify-content-center">
        ...
        <a href="index.html" class="logo">
            ...
            <div class="logo-lg">
              <span class="light-logo"><img src="{{ asset('admin/images/logo-dark-text.png') }}" alt=""></span>
              <span class="dark-logo"><img src="{{ asset('admin/images/logo-light-text.png') }}" alt=""></span>
            </div>
          </a>
	</div>
    <!-- Header Navbar -->
      ...
      <div class="navbar-custom-menu r-side">
        <ul class="nav navbar-nav">
		  ...
		  <li class="dropdown notifications-menu">
			<a href="tables_data.html#" class="waves-effect waves-light dropdown-toggle btn-outline no-border btn-info-light text-dark hover-white" data-bs-toggle="dropdown" title="Notifications">
			  ...
			  <li class="header">
				<div class="p-20">
					<div class="flexbox">
						...
						<div>
							<a href="tables_data.html#" class="text-danger">Clear All</a>
						</div>
					</div>
				</div>
			  </li>
          ...
          <li class="dropdown user user-menu">
            <a href="tables_data.html#" class="waves-effect waves-light dropdown-toggle no-border p-5 text-dark hover-white" data-bs-toggle="dropdown" title="User">
				<img class="avatar avatar-pill" src="{{ asset('admin/images/avatar/1.jpg') }}" alt="">
            </a>
            <ul class="dropdown-menu animated flipInX">
              <li class="user-body">
				 <a class="dropdown-item" href="tables_data.html#"><i class="ti-user text-muted me-2"></i> Profile</a>
				 <a class="dropdown-item" href="tables_data.html#"><i class="ti-wallet text-muted me-2"></i> My Wallet</a>
				 <a class="dropdown-item" href="tables_data.html#"><i class="ti-settings text-muted me-2"></i> Settings</a>
