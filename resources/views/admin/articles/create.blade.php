    ...
    <div class="container mt-5 ">
        <div class="card p-2">
            ...
            {{-- <form action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data" id="articleForm">
                ...
                <div class="mb-3">
                    <label for="word_file" class="form-label">Tải file Word</label>
            ...
            <script>
                ClassicEditor.create(document.querySelector('#content'), {
                    ckfinder: {
                        uploadUrl: '{{ route('upload.image') }}' // Đường dẫn upload ảnh
                    }
                ...
                // Đọc nội dung file Word và hiển thị trong CKEditor
                        ...
                        reader.onload = function (e) {
                            ...
                            mammoth.convertToHtml({ arrayBuffer: arrayBuffer })
                                .then(function (result) {
                                    ClassicEditor.instances.content.setData(result.value);
                                })
