    ...
    <div class="wrapper">
        ...
        {{-- <aside class="control-sidebar">
            ...
            <ul class="nav nav-tabs control-sidebar-tabs">
                <li class="nav-item"><a href="index.html#control-sidebar-home-tab" data-bs-toggle="tab"
                        class=""><i class="mdi mdi-message-text"></i></a></li>
                    ...
                    <div class="media-list media-list-hover mt-20">
                        <div class="media py-10 px-0">
                            <a class="avatar avatar-lg status-success" href="index.html#">
                                <img src="/admin/main/../images/avatar/1.jpg" alt="...">
                            </a>
                        ...
                        <div class="media py-10 px-0">
                            <a class="avatar avatar-lg status-danger" href="index.html#">
                                <img src="/admin/main/../images/avatar/2.jpg" alt="...">
                            </a>
                            <div class="media-body">
                                <p class="fs-16">
                        ...
                        <div class="media py-10 px-0">
                            <a class="avatar avatar-lg status-warning" href="index.html#">
                                <img src="/admin/main/../images/avatar/3.jpg" alt="...">
                            </a>
                            <div class="media-body">
                                <p class="fs-16">
                        ...
                        <div class="media py-10 px-0">
                            <a class="avatar avatar-lg status-primary" href="index.html#">
                                <img src="/admin/main/../images/avatar/4.jpg" alt="...">
                            </a>
                            <div class="media-body">
                                <p class="fs-16">
                                    <a class="hover-primary" href="index.html#"><strong>Evan</strong></a>
