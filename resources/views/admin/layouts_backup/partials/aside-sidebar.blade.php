@php
    ...
    // Đếm số yêu cầu chỉnh sửa bài viết chưa được xử lý
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{ route('admin.violations.approves') }}" style="position: relative;">
                                <i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>
                                Duyệt Report
                        ...
                        <li><a href="{{ route('admin.user-role-requests') }}" style="position: relative;">
                                <i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>
                                Yêu Cầu Nâng Cấp
