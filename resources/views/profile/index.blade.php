                    ...
                    <div class="card shadow-sm border-1 rounded-4">
                        <div class="card-body text-center p-5">
                            ...
                            <div class="d-flex justify-content-center gap-2">
                                <a href="#" class="btn btn-outline-primary rounded-circle p-2"><i class="la la-facebook-f"></i></a>
                                <a href="#" class="btn btn-outline-info rounded-circle p-2"><i class="la la-twitter"></i></a>
                                <a href="#" class="btn btn-outline-dark rounded-circle p-2"><i class="la la-behance"></i></a>
                                <a href="#" class="btn btn-outline-danger rounded-circle p-2"><i class="la la-youtube"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="meta-bot lh-1 mt-80">
                                                    <ul class="d-flex">
                                                        ...
                                                        <li class="author me-5">
                                                            <a href="page-author.html#"><i class="la la-user me-2"></i> by Admin
                                                            </a>
                                                        </li>
                                                        <li class="comment">
                                                            <a href="page-author.html#"><i class="la la-comment me-2"></i> 55
                                ...
                                <div class="item border-0 bg-gray1 p-3 mt-30">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="content">
                                                <div class="news-cat color-999 fsz-13px text-uppercase mb-3">
                                                    <a href="page-author.html#" class="text-danger">Sponsored Content</a>
                                                </div>
                                                <h3 class="title ltspc--1">
                                                ...
                                                <div class="meta-bot lh-1 mt-80">
                                                    <ul class="d-flex">
                                                        <li class="comment">
                                                            <a href="page-author.html#"> totalworks.com <i class="las la-external-link-square-alt ms-2"></i>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
                            ...
                            <div class="main-card">
                                ...
                                <div class="content">
                                    ...
                                    <div class="meta-bot">
                                        <ul class="d-flex">
                                            <li class="date me-4">
                                                <a href="page-author.html#"><i class="la la-calendar me-1"></i> Dec 14, 2022</a>
                                            </li>
                                            <li class="comment">
