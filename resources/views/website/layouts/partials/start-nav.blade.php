        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="nav-side navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="icon-link dropdown-toggle" id="notificationDropdown" role="button" data-bs-toggle="dropdown">
                    ...
                    <ul class="dropdownMenu dropdown-menu-end" style="margin-top: 0; margin-top: -50px; width: 300px;" aria-labelledby="notificationDropdown">
                        <li><h6 class="dropdown-header px-3">Thông báo mới</h6></li>
                        @auth
                                    ...
                                    <a class="dropdown-item d-flex align-items-start py-2 px-3"
                                       ...
                                       onclick="markNotificationAsRead('{{ $notification->id }}')">
                                        <div class="flex-shrink-0 me-2">
                                            <img src="{{ $notification->data['author_avatar'] ?? asset('images/default-avatar.png') }}" width="30" class="rounded-circle">
                                        </div>
                            ...
                            @empty
                                <li><div class="dropdown-item text-muted py-2 px-3">Không có thông báo mới</div></li>
                            @endforelse
                            <li><hr class="dropdown-divider my-1"></li>
                            <li>
                                <div class="d-flex justify-content-between px-3 py-1">
                                    <a class="small" href="{{ route('notifications.index') }}">Xem tất cả</a>
                                    <a class="small" href="#" onclick="markAllNotificationsAsRead(); return false;">Đánh dấu đã đọc</a>
                                </div>
                            </li>
                        @else
                            <li><a class="dropdown-item py-2 px-3" href="{{ route('loginuser') }}">Đăng nhập để xem thông báo</a></li>
                        @endauth
                    </ul>
                </li>
