            ...
            <div class="top-navbar style-1">
                <div class="container p-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4">
                            <a href="page-single-post-creative.html#" class="logo-brand d-none d-lg-block">
            ...
            <nav class="navbar navbar-expand-lg navbar-light style-1">
                <div class="container p-0">
                    <div class="mob-nav-toggles d-flex align-items-center justify-content-between">
                        ...
                        <a href="page-single-post-creative.html#" class="logo-brand d-block d-lg-none w-50 my-4">
                            <img src="assets/img/logo_home1.png" alt="" class="dark-none">
                            <img src="assets/img/logo_home1_lt.png" alt="" class="light-none">
                        </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="nav-side">
                            ...
                            <a href="page-single-post-creative.html#" class="icon-link noti-dot">
                                <i class="la la-shopping-bag fs-4"></i>
                            </a>
                            <a href="page-single-post-creative.html#" class="icon-link search-btn-style1">
