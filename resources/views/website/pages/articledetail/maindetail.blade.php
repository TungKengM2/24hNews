                        ...
                        <div class="tc-stock-card mb-30">
                            ...
                            <div class="stock-card-body">
                                <div class="stock-card-item">
                                    <div class="title">
                                        <h6>DOW <small class="indicator text-danger"> <i class="ion-arrow-down-b"></i>
                                                2,82%</small></h6>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="content">
                                            ...
                                            <h3 class="title mb-15"> <a href="page-single-post-creative.html">Manoah
                                                    dominates, closes in on Blue
                                                    Jays history</a> </h3>
                                            <div class="text color-666">
                                                The social-media company is in discussions to sell itself to Elon, a
                                            ...
                                            <div class="meta-bot lh-1 mt-50">
                                                <ul class="d-flex">
                                                    ...
                                                    <li class="author me-4">
                                                        <a href="home-default.html#"><i class="la la-user me-1"></i>
                                                            by Admin </a>
                                                    </li>
                                                    <li class="comment">
                                                        <a href="home-default.html#"><i
                                                                class="la la-comment me-1"></i> 55
                                                            Comments</a>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="tc-post-overlay-default">
                                        ...
                                        <div class="content ps-30 pe-30 pb-30">
                                            <h3 class="title mb-20">
                                                <a href="page-single-post-creative.html">Become master of strategy from
                                                    playing chess</a>
                                                </h2>
                                                <div class="meta-bot lh-1">
                                                    <ul class="d-flex">
                                                        ...
                                                        <li class="author me-5">
                                                            <a href="home-default.html#"><i
                                                                    class="la la-user me-2"></i> by Admin</a>
                                                        </li>
                                                        <li class="comment">
                                                            <a href="home-default.html#"><i
                                            ...
                                            <div class="item pb-20">
                                                <div class="content">
                                                    <a href="home-default.html#"
                                                        class="news-cat color-999 fsz-13px text-uppercase mb-1">business</a>
                                                    <h5 class="title ltspc--1">
                                                        <a href="page-single-post-creative.html">Stock Market meltdowns
                                                            have FAANGs looking
                                ...
                                <div class="item border-0 bg-gray1 p-3 mt-30">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="content">
                                                <div class="news-cat color-999 fsz-13px text-uppercase mb-3">
                                                    <a href="home-default.html#" class="text-danger">Sponsored
                                                        Content</a>
                                                </div>
                                                <h3 class="title ltspc--1">
                            ...
                            <div class="main-card">
                                ...
                                <div class="content">
                                    ...
                                    <div class="meta-bot">
                                        <ul class="d-flex">
                                            <li class="date me-4">
                                                <a href="home-default.html#"><i class="la la-calendar me-1"></i> Dec
                                                    14, 2022</a>
                                            </li>
                                            <li class="comment">
        ...
        <div class="container">
            <div class="content">
                <div class="row">
                                        ...
                                        <div class="content pt-20">
                                            ...
                                            <div class="meta-bot lh-1 mt-20">
                                                <ul class="d-flex">
                                                    ...
                                                    <li class="comment">
                                                        <a href="home-default.html#"><i
                                                                class="la la-comment me-2"></i> 7</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-4">
                        <p class="color-000 text-uppercase mb-30 ltspc-1"> <a href="page-blog.html">Entertaiment</a>
