        ...
        <div class="container">
            ...
            <div class="foot text-center py-4 border-1 border-top brd-gray">
                <p class="fsz-13px color-666">© 2023 Copyrights by <a href="page-single-post-creative.html#" class="color-000">Newzin</a>. All Rights
                    Reserved. Developed by <a href="page-single-post-creative.html#" class="color-000 text-decoration-underline">ThemesCamp</a></p>
            </div>
        </div>
        <!-- ====== start to top button ====== -->
        <a href="page-single-post-creative.html#" class="to_top">
