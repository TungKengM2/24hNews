...
@section('content')
    ...
    <main>
        ...
        {{--    --}}{{----}}
        {{--        // phần này của dương  mở ra là chạy đc--}}
        ...
        {{--                            <a class="link"--}}
        {{--                               href="{{ Auth::check() ? route('client.articles.article', $article->id) : url('/login-user') }}"--}}
        {{--                               class="item d-block">{{ $article->preview_contentt }}--}}
        {{--                            </a>--}}
        {{--                        @endforeach--}}
        {{--                    </div>--}}
        {{--                </div>--}}
        ...
        {{--                                                                <li class="views">--}}
        {{--                                                                    <a href="#"><i--}}
        {{--                                                                            class="la la-eye me-2"></i>{{ $article->views }}--}}
        {{--                                                                    </a>--}}
        {{--                                                                </li>--}}
        ...
        {{--                                                <img--}}
        {{--                                                    src="{{ $journalist->image ? asset('storage/' . $journalist->image) : 'https://i.pravatar.cc/150?img=4' }}"--}}
        ...
        {{--                                        <img--}}
        {{--                                            src="{{ $data['article']->thumbnail_url ? asset('storage/' . $data['article']->thumbnail_url) : 'https://via.placeholder.com/400' }}"--}}
                                    ...
                                    <div class="content pt-30">
                                        ...
                                        <div class="meta-bot lh-1 mt-40">
                                            <ul class="d-flex">
                                                ...
                                                <li class="author me-5">
                                                    <a href="home-default.html#"><i class="la la-user me-2"></i> by
                                                        Admin
                                                    </a>
                                                </li>
                                                <li class="comment">
                                    ...
                                    <div class="content pt-20">
                                        ...
                                        <div class="meta-bot lh-1 mt-20">
                                            <ul class="d-flex">
                                                ...
                                                <li class="comment">
                                                    <a href="home-default.html#"><i class="la la-comment me-2"></i> 8
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
