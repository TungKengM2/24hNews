                                                    ...
                                                    @if ($article->subcategory)
                                                        <div class="mt-1">
                                                            ...
                                                            @if (!$article->subcategory->is_active)
                                                                <span class="text-warning">{{ $article->subcategory->name }} <i
                                                                            class="fa fa-exclamation-triangle"></i></span>
                                                            @else
                                                ...
                                                <div class="d-flex flex-wrap gap-1 mb-2">
                                                    ...
                                                    @if (in_array($article->status, ['published', 'archived']))
                                                        <form action="{{ route('author.articles.toggle-visibility', $article) }}" method="POST" class="d-inline">
                                                            ...
                                                            @endif
                                                            <button class="btn btn-secondary btn-sm toggle-visibility-btn"
                                                    ...
                                                    <form action="{{ route('author.articles.destroy', $article) }}"
                                                        ...
                                                        @csrf
                                                        @method('DELETE')
                                                        <button class="btn btn-danger btn-sm delete-article-btn" title="Xóa bài viết"
                                                                data-article-id="{{ $article->article_id }}" data-article-title="{{ $article->title }}">
