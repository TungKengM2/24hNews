    ...
    <div class="navbar-custom-menu r-side">
        <ul class="nav navbar-nav">
            <li class="btn-group nav-item d-lg-inline-flex d-none">
                <a href="tables_data.html#" data-provide="fullscreen"
            ...
            <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu animated flipInX">
                    <li class="user-body">
                        <a class="dropdown-item" href="tables_data.html#"><i class="ti-user text-muted me-2"></i>
                            Profile</a>
                        <a class="dropdown-item" href="tables_data.html#"><i
                                class="ti-wallet text-muted me-2"></i> My Wallet</a>
                        <a class="dropdown-item" href="tables_data.html#"><i
                                class="ti-settings text-muted me-2"></i> Settings</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="tables_data.html#"><i class="ti-lock text-muted me-2"></i>
                            Logout</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a href="tables_data.html#" data-toggle="control-sidebar" title="Setting"
