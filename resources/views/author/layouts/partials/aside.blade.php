        ...
        <div class="profile-pic">
            ...
            <div class="profile-info">
                ...
                <div class="list-icons-item dropdown">
                    <a href="tables_data.html#" class="list-icons-item dropdown-toggle" data-bs-toggle="dropdown"><span
                            class="badge badge-ring fill badge-primary mx-2"></span>Online</a>
                    <div class="dropdown-menu">
                        <a href="tables_data.html#" class="dropdown-item">Update data</a>
                        <a href="tables_data.html#" class="dropdown-item">Detailed log</a>
                        <a href="tables_data.html#" class="dropdown-item">Statistics</a>
                        <a href="tables_data.html#" class="dropdown-item">Clear list</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="multinav-scroll" style="height: 100%;">
                ...
                <div class="sidebar-widgets">
                    <div class="copyright text-start m-25">
                        <p><strong class="d-block">24hNews Admin Dashboard</strong> © 2025 All Rights Reserved</p>
                    </div>
                </div>
            </div>
        </div>
